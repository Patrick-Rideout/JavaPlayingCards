 ...
 *
 ...
 •	Note: use constants for suits and think of how you can constrain the value. Hint: You can use constants or enums.
 •	Override the toString method to print the playing card like “8 ♣” or “K ♦” (static). (Hint: google ‘unicode character for diamond’)
 ...
 •	Can be shuffled
 •	Can draw a card
 •	Create an application with a menu that let’s you a) draw a card b) draw a hand c) print the deck, d) shuffle the deck and e) print out the deck
